...
public class Ninja extends Robot {
    ...
    public Ninja(String nev, Szin szin, Integer eletero, Boolean harcose, Integer sebzes, Integer vedelem, Fegyver fegyver, Pancel pancel, Sisak sisak, Cipo cipo) throws RobotHiba {
