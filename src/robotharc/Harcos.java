...
public class Harcos extends Robot {
    ...
    public Harcos(String nev, Szin szin, Integer eletero, Boolean harcose, Integer sebzes, Integer vedelem, Fegyver fegyver, Pancel pancel, Sisak sisak, Cipo cipo) throws RobotHiba {
